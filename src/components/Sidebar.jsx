  ...
  return (
    ...
    md:hover:overflow-auto pb-10'>
      ...
      <div className='flex justify-between items-center'>
        ...
        items-center gap-3 ml-3 mt-4 flex text-xl 
        font-extrabold tracking-tight dark:text-white text-slate-900'>
          <SiShopware /> <span>MarketStream</span>
        </Link>

        <TooltipComponent content="Menu" position="BottomCenter">
          <button
          type='button' onClick={() => setActiveMenu((prevActiveMenu) => !prevActiveMenu)}
          className='text-xl rounded-full p-3 
          hover:bg-light-gray mt-4 md:hidden'
          >
            <MdOutlineCancel />
          </button>
        </TooltipComponent>
